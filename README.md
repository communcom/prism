...
getPosts:                          // Получение ленты по определенному принципу
    ...
    type <string>('community')     // Тип ленты
        ...
        | voted                    // Лента постов, за которые пользователь проголосовал лайком
        ]
    sortBy <string>('time')        // Тип ленты
        [
          time                     // Сортировка по времени (от старых к новым)
        | timeDesc                 // Обратная сортировка по времени (от новых к старым)
        ]
...
getLeaderCommunities:            // Получить список комьюнити, в которых пользователь является лидером
    userId <string>              // Идентификатор комьюнити
    offset <number>(0)           // Сдвиг пагинации
    limit <number>(10)           // Количество элементов
...
=> Запрос комьюнити, в которых пользователь является лидером
        ...
        "items": [
            {
                ...
                "alias": "reddit",
                "issuer": "cmn4xnqkxpyq",
                "avatarUrl": "https://img.commun.com/images/3cRm9aFfNW6mqyAmR3SiWiWACg1W.jpg",
                "name": "Reddit",
                "subscribersCount": 163,
                "postsCount": 18
            },
            {
                "communityId": "POLITIC",
                "alias": "politics",
                "issuer": "cmn2ragkhjyp",
                "avatarUrl": "https://img.commun.com/images/4KKop1gfty5Uov6qnVESc82s2UHr.jpg",
                "name": "Politics",
